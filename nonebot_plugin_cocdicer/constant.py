...
TempInsanity = [
    "",
    "失忆：在{dur}轮之内，调查员会发现自己只记得最后身处的安全地点，却没有任何来到这里的记忆。",
    "假性残疾：调查员陷入了心理性的失明、失聪或躯体缺失感中，持续{dur}轮。",
    "暴力倾向：调查员陷入了六亲不认的暴力行为中，对周围的敌人与友方进行着无差别的攻击，持续{dur}轮。",
    "偏执：调查员陷入了严重的偏执妄想之中。有人在暗中窥视着他们，同伴中有人背叛了他们，没有人可以信任，万事皆虚。持续{dur}轮。",
    "人际依赖：调查员因为一些原因而将他人误认为了他重要的人并且努力的会与那个人保持那种关系，持续{dur}轮。",
    "昏厥：调查员当场昏倒，昏迷状态持续{dur}轮。",
    "逃避行为：调查员会用任何的手段试图逃离现在所处的位置，状态持续{dur}轮。",
    "竭嘶底里：调查员表现出大笑，哭泣，嘶吼，害怕等的极端情绪表现，持续{dur}轮。",
    "恐惧：调查员陷入对某一事物的恐惧之中，就算这一恐惧的事物是并不存在的，持续{dur}轮。\n{detail_roll}\n具体恐惧症: {detail}(守秘人也可以自行从恐惧症状表中选择其他症状)",
    "躁狂：调查员由于某种诱因进入躁狂状态，症状持续{dur}轮。\n{detail_roll}\n具体躁狂症: {detail}(KP也可以自行从躁狂症状表中选择其他症状)",
]

LongInsanity = [
    "",
    "失忆：在{dur}小时后，调查员回过神来，发现自己身处一个陌生的地方，并忘记了自己是谁。记忆会随时间恢复。",
    "被窃：调查员在{dur}小时后恢复清醒，发觉自己被盗，身体毫发无损。",
    "遍体鳞伤：调查员在{dur}小时后恢复清醒，发现自己身上满是拳痕和瘀伤。生命值减少到疯狂前的一半，但这不会造成重伤。调查员没有被窃。这种伤害如何持续到现在由守秘人决定。",
    "暴力倾向：调查员陷入强烈的暴力与破坏欲之中，持续{dur}小时。",
    "极端信念：在{dur}小时之内，调查员会采取极端和疯狂的表现手段展示他们的思想信念之一",
    "重要之人：在{dur}小时中，调查员将不顾一切地接近重要的那个人，并为他们之间的关系做出行动。",
    "被收容：{dur}小时后，调查员在精神病院病房或警察局牢房中回过神来",
    "逃避行为：{dur}小时后，调查员恢复清醒时发现自己在很远的地方",
    "恐惧：调查员患上一个新的恐惧症。调查员会在{dur}小时后恢复正常，并开始为避开恐惧源而采取任何措施。\n{detail_roll}\n具体恐惧症: {detail}(守秘人也可以自行从恐惧症状表中选择其他症状)",
    "躁狂：调查员患上一个新的躁狂症，在{dur}小时后恢复理智。在这次疯狂发作中，调查员将完全沉浸于其新的躁狂症状。这是否会被其他人理解（apparent to other people）则取决于守秘人和此调查员。\n{detail_roll}\n具体躁狂症: {detail}(KP也可以自行从躁狂症状表中选择其他症状)",
]
